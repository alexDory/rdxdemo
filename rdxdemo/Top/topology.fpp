module rdxdemo {
  ...
  topology rdxdemo {
    ...
    connections RateGroups {
      ...
      rateGroup1.RateGroupMemberOut[3] -> touchSensor.schedIn
    }
    ...
    connections rdxdemo {
      ...
      # touchSensor's gpioSet output is connected to gpioDriver's gpioWrite input
      touchSensor.gpioSetLed -> gpioDriver.gpioWrite

      # Connect the GpioRead port to the gpioReadTouch
      touchSensor.gpioReadTouch -> gpioDriver.gpioRead
