// ======================================================================
// \title  rdxdemoTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef RDXDEMO_RDXDEMOTOPOLOGY_HPP
#define RDXDEMO_RDXDEMOTOPOLOGY_HPP
// Included for access to rdxdemo::TopologyState and rdxdemo::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <rdxdemo/Top/rdxdemoTopologyDefs.hpp>

// Remove unnecessary rdxdemo:: qualifications
using namespace rdxdemo;
namespace rdxdemo {
/**
 ...
 * rdxdemo::TopologyState see: rdxdemoTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type rdxdemo::TopologyState see: rdxdemoTopologyDefs.hpp.
 *
