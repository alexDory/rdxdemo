// ======================================================================
// \title  rdxdemoTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <rdxdemo/Top/rdxdemoTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
// #include <rdxdemo/Top/rdxdemoPacketsAc.hpp>
...
void configureTopology() {
    ...
    // Configure GPIOs for touch sensor and LED
    gpioDriver.open(TOUCH_PIN, Arduino::GpioDriver::GpioDirection::IN);
    gpioDriver.open(LED_PIN, Arduino::GpioDriver::GpioDirection::OUT);
}

// Public functions for use in main program are namespaced with deployment name rdxdemo
namespace rdxdemo {
